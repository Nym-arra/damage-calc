...
const RBY: {[name: string]: MoveData} = {
  ...
  'Poison Sting': {bp: 35, type: 'Poison'},
  ...
  'Thunder Punch': {bp: 85, type: 'Electric'},
...
const GSC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Rock Smash': {bp: 70, type: 'Fighting'},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Water Shuriken': {makesContact: true},
  ...
  Overheat: {bp: 130, type: 'Fire', recoil: [33, 100], makesContact: true},
  ...
  'Winters Wrath': {bp: 80, type: 'Ice'},
  Howl: {bp: 0, category: 'Status', type: 'Normal'},
  'Dazzling Gleam': {bp: 70, type: '???'},
  Moonblast: {bp: 95, type: '???'},
  ...
  Superpower: {bp: 120, type: 'Fighting', recoil: [33, 100], makesContact: true},
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Water Shuriken': {category: 'Physical'},
  ...
  'Winters Wrath': {category: 'Special'},
  ...
  'Rock Smash': {bp: 70, category: 'Physical'},
  ...
  'Zap Cannon': {bp: 110, category: 'Special'},
  ...
  Chatter: {bp: 80, type: 'Flying', isSound: true, category: 'Special'},
  ...
  'Draco Meteor': {bp: 130, type: 'Dragon', recoil: [33, 100], category: 'Special'},
  ...
  'Leaf Storm': {bp: 130, type: 'Grass', recoil: [33, 100], category: 'Special'},
...
const BW_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Jump Kick': {bp: 100},
  'Dazzling Gleam': {secondaries: true},
  'Mirror Shot': {secondaries: true},
  Moonblast: {secondaries: true},
...
const SV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Dazzling Gleam': {bp: 95, zp: 175, maxPower: 130},
  Moonblast: {bp: 95, zp: 175, maxPower: 130},
